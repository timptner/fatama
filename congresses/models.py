...
class Congress(models.Model):
    ...
    location = models.CharField(
        "Austragungsort", max_length=150, help_text="Die Stadt reicht aus."
    )
    ...
    support_email = models.EmailField(
        "E-Mail-Adresse", help_text="Erreichbarkeit der Organisatoren."
    )
    support_team = models.CharField(
        "Team",
...
class Portrait(models.Model):
    ...
    SIZE_CHOICES = {
        ...
        DOUBLE_EXTRA_LARGE: "Extra groß (2XL)",
    }
    ...
    railcard = models.CharField(
        "Deutschlandticket", choices=RAILCARD_CHOICES, max_length=4
    )
    certificate = models.FileField(
        "Immatrikulationsbescheinigung",
        upload_to=participant_directory_path,
        validators=[FileExtensionValidator(["pdf"])],
        null=True,
    )
    size = models.CharField("Konfektionsgröße", choices=SIZE_CHOICES, max_length=3)
